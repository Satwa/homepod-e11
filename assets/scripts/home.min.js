...
function getScrollPosition(){scrollBody=body.scrollTop;scrollHtml=html.scrollTop;return 0==scrollBody?scrollHtml:scrollBody}space_recognition_video.onPlay=playVideo();space_recognition_video.onended=pauseVideo;space_recognition_video_control.addEventListener("click",function(a){a.preventDefault();space_recognition_video.paused?playVideo():pauseVideo()});function playVideo(){space_recognition_video.play();space_recognition_video.paused||space_recognition_video_control.classList.add("playing")}
function pauseVideo(){space_recognition_video.pause();space_recognition_video_control.classList.remove("playing")}function setInfoCardWidth(){for(var a=0;a<slides.length;a++)slides[a].style.width=slide_width-arrow_left.offsetWidth-arrow_right.offsetWidth+"px"}
