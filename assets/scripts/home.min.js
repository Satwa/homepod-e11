var video_already_played=!1,clientHeight=document.documentElement.clientHeight,sectionsToAnim=document.querySelectorAll(".entryAnim:not(.opened)"),space_recognition_video_control,space_recognition_video,hello_siri,body=document.querySelector("body"),html=document.querySelector("html"),homepod_container=html.querySelector(".homepodContainer"),at_home=body.querySelector("#at-home"),slider=document.querySelector(".slider"),slider__container=document.querySelector(".slider__container"),slides=document.querySelectorAll(".slider__container__infoCard"),
...
window.onload=function(){loadSpaceRecognitionVideo();loadHelloSiriVideo()};
function loadHelloSiriVideo(){if(/constructor/i.test(window.HTMLElement)||"[object SafariRemoteNotification]"===(!window.safari||"undefined"!==typeof safari&&safari.pushNotification).toString()){var a=document.querySelector("#helloSiriVideo");fetch("https://homepod.joshua.ovh/async/hello_siri.html").then(function(a){return a.text()}).then(function(b){a.innerHTML=b;hello_siri=body.querySelector("#hello_siri");updateScrollPosition()})["catch"](function(a){console.log("Failed to fetch page: ",a)})}}
