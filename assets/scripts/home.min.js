...
window.onload=function(){loadSpaceRecognitionVideo();loadHelloSiriVideo()};function loadHelloSiriVideo(){var a=document.querySelector("#helloSiriVideo");fetch("https://homepod.joshua.ovh/async/hello_siri.html").then(function(a){return a.text()}).then(function(b){a.innerHTML=b;hello_siri=body.querySelector("#hello_siri");updateScrollPosition()})["catch"](function(a){console.log("Failed to fetch page: ",a)})}
